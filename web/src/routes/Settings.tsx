        ...
        <div style={{ maxWidth: 658 }}>
          {activeTab === "colors" && (
            <>
              ...
              >
                Rename colors to match how you actually read. The first five
                colors are available from the extension toolbar with number
                keys.
              </p>
              ...
              {addingColor ? (
                ...
                >
                  ...
                  <div className="mt-4 flex justify-end gap-2">
                    ...
                    <Button className="h-8 text-xs" onClick={addColor}>
                      Add color
                    </Button>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                >
                  <Select
                    value={typography}
                    onValueChange={(value) =>
                      setTypography(value as TypographyChoice)
                    }
                  >
                    ...
                    <SelectContent>
                      <SelectGroup>
                        {(
                          Object.keys(TYPOGRAPHY_OPTIONS) as TypographyChoice[]
                        ).map((key) => (
          ...
          {activeTab === "shortcuts" && (
            <>
              ...
              <p
                ...
                style={{ color: "var(--ink-3)" }}
              >
                These shortcuts are active in the dashboard. Number keys also
                work in the extension selection toolbar.
              </p>
              {[
            ...
            <>
              ...
              >
                ...
                <p
                  ...
                  style={{ color: "var(--ink-3)" }}
                >
                  AI summaries will turn groups of highlights into review notes
                  and help answer questions from your library.
                </p>
              </div>
            </>
          )}
